...
export function SuperIdCardMakerCaseStudy({ project }: { project: Project }) {
    ...
    <div className="bg-[#F1ECE2] dark:bg-background w-full min-h-screen text-[#5E5E5E] dark:text-muted-foreground font-['Jost'] pb-32 pt-24">
      ...
      <section className="px-5 mx-auto max-w-[1920px]">
        <div className="relative w-full h-[600px] lg:h-[800px] rounded-[10px] overflow-hidden flex flex-col items-center justify-center bg-black">
          <ImageWithFallback 
            src={bannerImg} 
            alt="Super ID Card Maker Banner" 
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-0">
        ...
        <section className="mt-32">
          <Reveal>
            ...
            <p className="text-[22px] leading-[32px] mb-16 text-[#5E5E5E] dark:text-muted-foreground">
              Bulk ID card printing often suffers from inefficiencies that cause errors and waste. The main pain points were:
            </p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <Reveal delay={0.1}>
              <div className="relative pt-6 pl-6">
                ...
                <div className="relative bg-[#FAFCFF] dark:bg-card rounded-[15px] p-8 shadow-[-5px_-5px_20px_rgba(207,74,37,0.1)] z-10 h-full">
                  <h3 className="font-['Jost'] font-medium text-[20px] text-[#CF4A25] mb-4">Manual data entry doesn't scale</h3>
                  <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                    Entering each person's details by hand for large batches (hundreds or thousands of cards) is slow and highly error-prone—a single typo can mean a reprinted card.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="relative pt-6 pl-6">
                ...
                <div className="relative bg-[#FAFCFF] dark:bg-card rounded-[15px] p-8 shadow-[-5px_-5px_20px_rgba(207,74,37,0.1)] z-10 h-full">
                  <h3 className="font-['Jost'] font-medium text-[20px] text-[#CF4A25] mb-4">No reusable way to design</h3>
                  <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                    Without a proper batch system, every card effectively has to be treated as a one-off, even when the layout is identical across an entire organisation or event.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="relative pt-6 pl-6">
                ...
                <div className="relative bg-[#FAFCFF] dark:bg-card rounded-[15px] p-8 shadow-[-5px_-5px_20px_rgba(207,74,37,0.1)] z-10 h-full">
                  <h3 className="font-['Jost'] font-medium text-[20px] text-[#CF4A25] mb-4">Printer and layout issues</h3>
                  <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                    Card designs not properly aligned to real-world printer and card-stock dimensions lead to misprints, wasted material, and inconsistent output.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              <div className="relative pt-6 pl-6">
                ...
                <div className="relative bg-[#FAFCFF] dark:bg-card rounded-[15px] p-8 shadow-[-5px_-5px_20px_rgba(207,74,37,0.1)] z-10 h-full">
                  <h3 className="font-['Jost'] font-medium text-[20px] text-[#CF4A25] mb-4">No live preview</h3>
                  <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                    Without seeing how imported data will actually populate the design beforehand, errors in mapping or layout are only caught after cards are already printed.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <div className="w-full bg-[#F6F9FF] dark:bg-card border border-[#DDE8FF] dark:border-border rounded-[30px] overflow-hidden flex flex-col">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1.5fr_2fr_2fr] bg-[#FFF8EA] dark:bg-muted border-b border-[#DDE8FF] dark:border-border">
                ...
                <div className="flex items-center justify-center gap-4 py-8 border-b md:border-b-0 md:border-r border-[#DDE8FF] dark:border-border">
                  <span className="font-['Jost'] font-medium text-[18px] text-[#313131] dark:text-foreground">Established competitors</span>
                </div>
                <div className="flex items-center justify-center gap-4 py-8">
                  <span className="font-['Jost'] font-bold text-[22px] text-[#CF4A25]">Super ID Card Maker</span>
                </div>
              </div>
              ...
              {[
                {
                  label: "Data import",
                  competitor: "Excel/CSV import, standard across the category",
                  ours: "Excel import with direct field mapping",
                  bg: "bg-[#FFF0EB] dark:bg-muted/50",
                },
                {
                  label: "Templates",
                  competitor: "Present in most tools, varying quality/range",
                  ours: "Prebuilt template library + ability to design and save custom templates",
                  bg: "bg-[#FFF0EB] dark:bg-muted/20",
                },
                {
                  label: "Preview before print",
                  competitor: "Inconsistent across tools",
                  ours: "Live data preview while designing",
                  bg: "bg-[#FFF0EB] dark:bg-muted/50",
                },
                {
                  label: "Field mapping",
                  competitor: "Often list/dropdown-based",
                  ours: "Drag-and-drop mapping directly onto the card design",
                  bg: "bg-[#FFF0EB] dark:bg-muted/20",
                },
              ].map((row, idx) => (
                <div key={idx} className={`grid grid-cols-1 md:grid-cols-[1.5fr_2fr_2fr] border-b border-[#DDE8FF] dark:border-border last:border-b-0 ${row.bg}`}>
                  ...
                  <div className="py-6 px-10 flex items-center">
                    <span className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground">{row.ours}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-6 font-['Jost'] font-normal text-[22px] leading-[32px] text-[#5E5E5E] dark:text-muted-foreground">
                  <p>
                    <strong>Batch processing from Excel/CSV is the baseline expectation</strong>, not a differentiator: any tool in this category without it would be immediately disqualified by users.
                  </p>
                  <p>
                    <strong>Reusability of templates is a major time-saver</strong> for repeat use cases, which directly shaped the decision to add prebuilt templates and custom template saving in this revamp.
                  </p>
                  <p>
                    <strong>Field mapping is where user error most often originates</strong>: when the connection between a spreadsheet column and a design field isn't visual and direct, mismatches are easy to make at scale.
                  </p>
                  <p>
                    <strong>A preview step before printing is essential risk mitigation</strong> for bulk physical output.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-[#F6F9FF] dark:bg-card border border-[#DDE8FF] dark:border-border rounded-[30px] p-10 h-full flex flex-col gap-6 relative overflow-hidden">
                ...
                <div className="flex flex-col xl:flex-row items-center gap-4 z-10 relative">
                  ...
                  <h3 className="font-['Caveat_Brush',cursive] text-[52px] leading-tight text-[#CF4A25]">
                    Anitha, School Administrator
                  </h3>
                </div>
                </div>
                <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                  <strong>38 years old</strong>, issues new student ID cards at the start of every academic year. Manages data for hundreds of students in a single Excel sheet.
                </p>
                <div className="flex flex-col gap-4 mt-auto">
                  <div>
                    <span className="font-['Jost'] font-medium text-[18px] text-[#313131] dark:text-foreground">Needs:</span>
                    <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">The same card design reused every year with only the underlying data changing. Needs a visual, self-explanatory mapping process.</p>
                  </div>
                  <div>
                    <span className="font-['Jost'] font-medium text-[18px] text-[#313131] dark:text-foreground">Goal:</span>
                    <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">Import this year's student list and get accurate, print-ready ID cards without manually checking each one.</p>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="bg-[#F6F9FF] dark:bg-card border border-[#DDE8FF] dark:border-border rounded-[30px] p-10 h-full flex flex-col gap-6 relative overflow-hidden">
                ...
                <div className="flex flex-col xl:flex-row items-center gap-4 z-10 relative">
                  ...
                  <div>
                  <h3 className="font-['Caveat_Brush',cursive] text-[52px] leading-tight text-[#CF4A25]">
                    Rakesh, HR Coordinator
                  </h3>
                </div>
                </div>
                <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">
                  <strong>31 years old</strong>, manages employee ID issuance for a mid-sized company with regular new hires.
                </p>
                <div className="flex flex-col gap-4 mt-auto">
                  <div>
                    <span className="font-['Jost'] font-medium text-[18px] text-[#313131] dark:text-foreground">Needs:</span>
                    <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">To build and save a custom template once, rather than rebuild it for every new hiring batch.</p>
                  </div>
                  <div>
                    <span className="font-['Jost'] font-medium text-[18px] text-[#313131] dark:text-foreground">Goal:</span>
                    <p className="font-['Jost'] font-normal text-[18px] text-[#5E5E5E] dark:text-muted-foreground leading-[26px]">Reuse a saved template confidently, catch mapping errors before committing to a physical print run.</p>
                  </div>
                </div>
              </div>
            </Reveal>
        ...
        <section className="mt-32">
          ...
          <Reveal delay={0.2}>
            ...
            <p className="mt-8 text-center text-[20px] text-[#5E5E5E] dark:text-muted-foreground max-w-4xl mx-auto font-['Jost']">
              Create/Select Template → Import Excel Data → Map Fields to Design → Live Preview → Batch Print
            </p>
          </Reveal>
        </section>
                ...
                {/* 8. Low Fidelity */}
        <LowFidelitySection 
          description="Three core low-fidelity screens established the structural foundation for this revamp:"
          steps={[
            {
              title: "New File",
              description: "Entry point offering a choice between starting from a blank canvas or selecting from the prebuilt template library—surfacing the new template system immediately.",
              uiType: "add"
            },
            {
              title: "Template Designer",
              description: "The card layout canvas, with data fields placed as objects that can later be mapped to spreadsheet columns—establishing the design surface as data-aware.",
              uiType: "detail"
            },
            {
              title: "Data Import",
              description: "Excel/CSV upload paired with a drag-and-drop mapping area, letting users visually connect spreadsheet columns to design fields.",
              uiType: "catalog"
            }
          ]}
        />
        ...
        <section className="mt-48">
          <Reveal>
            ...
            <p className="text-[20px] leading-[30px] mb-16 max-w-4xl text-[#5E5E5E] dark:text-muted-foreground">
              A restrained black/white/grey palette keeps focus on the card canvas itself—the one part of the interface where colour and content genuinely need to stand out.
            </p>
          </Reveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.8fr] gap-16 items-start">
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-2">
                  <div className="w-full max-w-[688px] h-[80px] rounded-[15px] bg-[#FFFEFC] border border-[#E5E5E5]"></div>
                  <span className="font-['Jost'] text-[18px] text-[#5E5E5E] dark:text-muted-foreground">#FFFEFC - Pearl White</span>
                </div>
                {/* Grey (Surface) */}
                <div className="flex flex-col gap-2">
                  <div className="w-full max-w-[569px] h-[80px] rounded-[15px] bg-[#F8F8F8] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.15)]"></div>
                  <span className="font-['Jost'] text-[18px] text-[#5E5E5E] dark:text-muted-foreground">#F8F8F8 - Grey (Surface)</span>
                </div>
                
                <div className="flex flex-wrap gap-8">
                  {/* Black */}
                  <div className="flex flex-col gap-2 flex-1 min-w-[200px]">
                    <div className="w-full max-w-[402px] h-[80px] rounded-[15px] bg-[#1D1D1D] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.15)]"></div>
                    <span className="font-['Jost'] text-[18px] text-[#5E5E5E] dark:text-muted-foreground">#1D1D1D - Black</span>
                  </div>
                  {/* Outline */}
                  <div className="flex flex-col gap-2 w-[255px] shrink-0">
                    <div className="w-full h-[80px] rounded-[15px] bg-[#313131]"></div>
                    <span className="font-['Jost'] text-[18px] text-[#5E5E5E] dark:text-muted-foreground">#313131 - Outline</span>
                  </div>
                </div>
              </div>
            ...
            {[screen1, screen2, screen3].map((img, i) => (
              <Reveal delay={i * 0.1} key={i}>
                <div className="w-full flex justify-center drop-shadow-xl hover:-translate-y-2 transition-transform duration-500">
                  <ImageWithFallback src={img} alt={`Super ID Card Maker Screen ${i + 1}`} className="w-full max-w-[400px] h-auto object-contain rounded-[30px]" />
                </div>
              </Reveal>
            ))}
          </div>
